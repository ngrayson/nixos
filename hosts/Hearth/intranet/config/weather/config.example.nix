...
# AQI (the dashboard's AQI reading) comes from AirNow, not Open-Meteo:
...
# payload and every location shows "AQI —".
# Poll no faster than 300s; AirNow observations only update about hourly.
{
  ...
  # long: temp, sky, wind, AQI, plus sun/moon rise/set and moon phase.
  # short: temp, sky, wind, AQI only.
