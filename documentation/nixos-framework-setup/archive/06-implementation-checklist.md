...
- [x] **Phase 1 cheat sheet (+ `os-rebuild` helper)** — [01 — Notes](./01-baseline-nix-packages.md#notes), [`os-rebuild.sh`](../os-rebuild.sh) (parent of `archive/`; install to `PATH` as you prefer).
