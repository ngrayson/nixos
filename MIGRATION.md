...
- **2026-04-27 — Wallust (optional live theming):** Repo **[`wallust/`](./wallust/)** + **[`home/theme-dynamic.nix`](./home/theme-dynamic.nix)**. Set **`theme.dynamic = true`** in [`home.nix`](./home.nix) to disable Stylix Hyprland/GTK colors and use **`wallust-run`** + **`theme-reload`**. Default **`theme.dynamic = false`** (Stylix only). Quickshell loads **[`quickshell/WallustColors.qml`](./quickshell/WallustColors.qml)** (wallust overwrites when iterating).
